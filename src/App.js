...
const notesArray= [{id: 1, heading:'My Notes - 1', value:'This is a note'},
              {id: 2, heading:'My Notes - 2', value:'This is another note'},
              {id: 3, heading:'My Notes - 3', value:'This is the third note'}]
...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
      <button className='add-note' onClick={this.addNew}>ADD A NEW NOTE</button>
